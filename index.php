...
<head>
    ...
    <title>Online Electronic Store</title>
	 <link rel="shortcut icon" href="assets/img/Website_Logo.png" type="image/x-icon" />
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/Website_Logo.png" alt=""  /></a>
            </div>
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE ELECTRONIC STORE <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
           ...
           <div class="row" >
                 ...
                 <hr />
                   ...
                   <p >
					   ...
					   what we need on our electronic needs.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  >Technical equipments specialist</a>
                </div>
                   </div>
                 ...
                 <hr />
				   ...
				   <br />
               <a class="btn btn-info btn-set"  >Mobile reviewer</a>
                </div>
                   </div>
               ...
               <a class="btn btn-info btn-set"  >Manager at leading Tech company</a>
                </div>
                   </div>
                 ...
                 <hr />
				   ...
				   <br />
				   <br />
               <a class="btn btn-info btn-set"  >Electronic review magazine writer</a>
                </div>
                   </div>
...
<div class="container">
           <div class="row" >
                    ...
                    <img class="img img-rounded img-responsive" src="assets/img/logocollab.jpg"  style="width:2000px;height:500px;"/>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div ">
                        <h4>Government Polytechnic,Aurangabad</h4>
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong>9730244320</h4>
                        <h4><strong>Email: </strong>govindgggmajage@gmail.com</h4>
                    </div>
                    </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
            <a style="color: #fff" target="_blank">Design by : 177203,177211,177054,177208</a>
    </div>
     <!-- FOOTER SECTION END-->
